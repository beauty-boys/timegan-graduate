...
def EEH_data_loading(data_name, seq_len):
...
def Xinjiang_data_loading(data_name, seq_len):
  assert data_name in ['xinjiang']

  ori_data = np.loadtxt('data/xinjiang.csv', delimiter=",", skiprows=1,usecols=range(1, 10))
  ori_data = MinMaxScaler(ori_data)
...
def Portugal_data_loading(data_name, seq_len):
  assert data_name in ['Portugal']

  ori_data = np.loadtxt('data/Portugal.csv', delimiter=",", skiprows=1, usecols=range(1, 10))
  ori_data = MinMaxScaler(ori_data)
